...
class TestLruCacher(unittest.TestCase):

	def setUp(self):
		pass
		
	def test_instantiation(self):
		c = LruCacher(0, lambda n: n**2)
		self.assertIsInstance(c, LruCacher)
		
		with self.assertRaises(ValueError):
			LruCacher(-1, lambda n: n**2)
...
if __name__ == '__main__':
	suite = unittest.TestLoader().loadTestsFromTestCase(TestLruCacher)
